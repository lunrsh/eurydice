...
[![Build Status](https://git.lunr.sh/luna/eurydice/actions/workflows/build-app.yml/badge.svg)](https://git.lunr.sh/luna/eurydice/actions)
...
<img align="left" width="295" height="182" src="https://git.lunr.sh/luna/eurydice/media/branch/main/assets/readme/main.png">

Eurydice has first-class playlist management capabilities, allowing you to create, edit, and manage playlists with ease. The user interface is designed to be as intuitive and easy to use as possible, to get out of your way and let you focus on your music.

### Playlist Management

<img align="right" width="295" height="182" src="https://git.lunr.sh/luna/eurydice/media/branch/main/assets/readme/delete.png">

Eurydice allows you to create, edit, and delete playlists with just a click. It also lets you do the same to songs, too (as pictured)!
