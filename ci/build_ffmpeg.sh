...
pushd /tmp/ffmpeg
./configure --arch=x86_64 --target-os=mingw32 --cross-prefix=x86_64-w64-mingw32- --ld="$LD" --disable-programs --enable-gpl --enable-libmp3lame --enable-nonfree --enable-static --disable-shared
make
sudo make install # TODO: unsafe, migrate to prefix soon
popd
